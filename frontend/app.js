...
const App = () => {
  ...
  const initializeApp = async () => {
    ...
    try {
      ...
      if (connected) {
        ...
        setError(
          "No se puede conectar al servidor. Verifica que esté ejecutándose en http://localhost:3000"
        );
      }
    } catch (error) {
  ...
  const handleVectorStoreChange = (newStore, additionalInfo = null) => {
    ...
    if (newStore && newStore !== "") {
      console.log(
        `Context changed to: ${newStore}. Chat continues in unified session.`
      );
    } else {
  ...
  // Handler para recargar documentos cuando hay cambios en los chats
  const handleChatUpdate = async (chatId, changeInfo) => {
    console.log("Chat updated:", chatId, changeInfo);

    // Si se creó un nuevo chat, recargar documentos para actualizar el vector selector
    if (changeInfo.action === "created") {
      console.log("New chat created, reloading documents for vector selector");
      // Recargar documentos del usuario actual
      if (selectedUser) {
        await loadUserDocuments(selectedUser);
      }
    }
  };
          ...
          <div className="error-content">
            ...
            <div className="connection-help">
              ...
              <ol>
                ...
                <li>
                  Ejecuta <code>npm start</code> en el directorio del proyecto
                </li>
                <li>
                  El servidor debe estar disponible en{" "}
    ...
    <div className="app">
      ...
      <header
        className={`app-header ${
          chatSidebarCollapsed ? "sidebar-collapsed" : ""
        }`}
      >
        <div className="header-left">
          <div className="header-title">
      ...
      >
        ...
        >
              ...
              {selectedUser ? (
                ...
                <div className="welcome-message">
                  <div className="welcome-content">
                    ...
                    <p>
                      Para comenzar, selecciona un usuario desde el sidebar
                      izquierdo.
                    </p>
                    <p>
                      Una vez seleccionado un usuario, podrás empezar a chatear
                      con tus documentos.
                    </p>
          ...
          <aside
            className={`tools-sidebar ${isSidebarCollapsed ? "collapsed" : ""}`}
          >
